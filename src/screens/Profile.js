	...
	render() {
		...
		return (
			<View style={ styles.container }>
				<LinearGradient colors={[COLORS.orange, COLORS.lightOrange]} style={{ flex: 4, paddingBottom: 20 }}>
					<TouchableOpacity style={styles.gearIcon} onPress={() => this.props.navigation.navigate('Settings')}>
						<Icon
							name='cog'
							type='font-awesome-5'
							size={25}
